...
;multiplies long number by a short with mov
;    r10 -- address of multiplier #1 (long number)
;    r11 -- multiplier #2 (short number)
;    rcx -- length of long numbers in qwords
;    r10 -- address of our temporary result (long number)
; result:
...
;    rcx -- length of long numbers in qwords
;    r8 -- address of our temporary result (long number)
; result:
